...
<html lang="en">
        ...
        <body>
                <header><h1>Mastermind: You Lose...</h1></header>
                <nav>
                        <ul>
		...
		<?php
			...
			$solution=$_SESSION["Mastermind"]->getSolution();
			for($i=0;$i<10;$i++){ ?>
			<tr>
			        <th> <?php echo $i+1; ?> </th>
				<?php for($j=0;$j<4;$j++){ ?>
			...
			<?php } ?>
			<tr>
				<th> <?php echo 'Solution'; ?>
				<?php for($j=0;$j<4;$j++){ ?>
					<th> <span class="dot" style= <?php echo "background-color:".$solution[$j]; ?> ></span> </th>
				<?php  } ?>
		        </tr>
